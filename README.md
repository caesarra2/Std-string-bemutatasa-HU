...
***Megjegyzés:*** *Számos tagfüggvény rendelkezik több túlterhelt változattal is, tehát gondosan ügyeljünk arra, hogy milyen paraméterekkel látjuk el a függvényünket.*
...
Rögtön az életkor bekérése után megszabadulhatunk a nem kívánt 'newline' karaktertől az *std::cin.get()* használatával, melyet ha nem látunk el paraméterekkel kinyer egy karaktert az input bufferből(Ami jelen esetben egy '\n').    
